...
public class ArrayTest {
  ...
  private static void lösung3() {
    double summe = 0;
    double plusMinus = 0;
    int i = 0;
    for( double zahl : zahlen ) { // Erweiterte for-Schleife
      if (i % 2 == 0) // wenn i gerade Zahl ist
        plusMinus = plusMinus + zahl;
      else            // i ist ungerade
        plusMinus = plusMinus - zahl;
      summe = summe + zahl;
      i++;
  ...
  private static void lösung1() {
    // =============================================================================
    double summe = 0;
    for( double zahl : zahlen ) { // Erweiterte for-Schleife (enhanced for loop = foreach)
